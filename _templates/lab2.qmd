...
```
###### Question 1
In the code below, change `geom_point()` to `geom_jitter()`. Adjust the size to `2`, the alpha to `0.5`, and set the height of the jitter to `0.2`. If successful, your plot should look like mine below.
