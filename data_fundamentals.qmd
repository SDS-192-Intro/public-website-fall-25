...
4. Click the Data tab at the top of the page. This previews this data as a rectangular dataset. 
...
nyc_urban_ranger %>%
  ...
  geom_col() +
  coord_flip() +
  labs(title="Top 10 Most Common Species for which NYC Urban Park Rangers Assistance is Requested, 2018-2024", x = "Species", y = "Count") +
  theme_minimal() +
